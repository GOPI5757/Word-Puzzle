        ...
        for i in range(self.rows):
            for j in range(self.cols):
                self.board[i][j] = Button(
                    text=self.board[i][j], on_press=partial(pressed, i, j), font_name="font\gamefont.ttf",
                    font_size=18, color=(0, 0, 0, 1), background_normal="board_texture.png", background_color=(0.6, 1, 1, 1), background_down="board_texture_pressed.png", border=(0, 0, 0, 0))
